...
class Sizes {
  ...
  /// Text Scaling
  static const avgTextScaleFactor = 1.1;
  static const maxTextScaleFactor = 1.2;
...
class Paddings {
  static const scaffoldHorizontal = EdgeInsets.symmetric(horizontal: Sizes.p20);
  static const scaffoldAll =
      EdgeInsets.symmetric(horizontal: Sizes.p20, vertical: Sizes.p32);
}
